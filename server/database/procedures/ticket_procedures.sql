...
BEGIN
SELECT t.ticket_id as ticket_id, t.title as title, t.info as info, t.price as price, t.count as count, t.event as event 
FROM ticket t INNER JOIN event e on t.ticket_id = e.event_id 
